...
no03.addEventListener("click", trocaNo);
...
no01.addEventListener("click", trocaNo2);
...
no04.addEventListener("click", trocaNo3);
...
no02.addEventListener("click", trocaNo4);
...
no05.addEventListener("click", trocaNo5);
